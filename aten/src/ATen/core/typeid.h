...
CAFFE_DECLARE_KNOWN_TYPE(8, std::complex<float>)
CAFFE_DECLARE_KNOWN_TYPE(9, std::complex<double>)
// 10 = undefined type id

CAFFE_DECLARE_KNOWN_TYPE(11, Tensor)
CAFFE_DECLARE_KNOWN_TYPE(12, std::string)
CAFFE_DECLARE_KNOWN_TYPE(13, bool)
CAFFE_DECLARE_KNOWN_TYPE(14, uint16_t)
CAFFE_DECLARE_KNOWN_TYPE(15, char)
CAFFE_DECLARE_KNOWN_TYPE(16, std::unique_ptr<std::mutex>)
CAFFE_DECLARE_KNOWN_TYPE(17, std::unique_ptr<std::atomic<bool>>)
CAFFE_DECLARE_KNOWN_TYPE(18, std::vector<int32_t>)
CAFFE_DECLARE_KNOWN_TYPE(19, std::vector<int64_t>)
CAFFE_DECLARE_KNOWN_TYPE(20, std::vector<unsigned long>)
CAFFE_DECLARE_KNOWN_TYPE(21, bool*)
CAFFE_DECLARE_KNOWN_TYPE(22, char*)
CAFFE_DECLARE_KNOWN_TYPE(23, int*)

#ifdef CAFFE2_UNIQUE_LONG_TYPEMETA
CAFFE_DECLARE_KNOWN_TYPE(24, long)
CAFFE_DECLARE_KNOWN_TYPE(25, std::vector<long>)
#endif // CAFFE2_UNIQUE_LONG_TYPEMETA

CAFFE_DECLARE_KNOWN_TYPE(26, _CaffeHighestPreallocatedTypeId)
} // namespace caffe2
