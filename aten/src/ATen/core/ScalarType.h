...
_(std::complex<double>,ComplexDouble,z) /* 9 */
// I'm not wedded to the names ComplexFloat and ComplexDouble,
// please feel free to rename per taste
...
#undef DEFINE_ENUM
  Undefined, // 10 (This got renumbered; I hope that's OK)
  NumOptions
};
