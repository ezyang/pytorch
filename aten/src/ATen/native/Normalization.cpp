...
Tensor batch_norm(
  ...
  // TODO: This checking code is duplicated with that in
  // CUDANormalization.  Not sure about a good place to put it.
  ...
  if (input.type().is_cuda()) {
    return at::_batch_norm_cuda(input, weight, bias, running_mean, running_var, training, momentum, eps, cudnn_enabled);
  }
