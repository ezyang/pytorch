...
def forward(self, crop_camera_1, mask_1):
    ...
    detach = torch.ops.aten.detach.default(eye);  eye = None
    _tensor_constant0 = self._tensor_constant0
    lift_fresh_copy = torch.ops.aten.lift_fresh_copy.default(_tensor_constant0);  _tensor_constant0 = None
    select = torch.ops.aten.select.int(detach, 0, 0)
    ...
    expand = torch.ops.aten.expand.default(detach, [sym_size, 3, 3])
    ...
    expand_3 = torch.ops.aten.expand.default(detach, [sym_size, 3, 3]);  detach = None
