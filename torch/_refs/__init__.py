...
def empty_like(
    ...
    *,
    ...
    options = {"dtype": dtype, "layout": layout, "device": device, "pin_memory": pin_memory}

    check(not (layout != torch.strided and memory_format is not None),
    ...
    if memory_format == torch.preserve_format:
        ...
        # TODO: test if support_as_strided()
            ...
            result = torch.empty(self.size(), memory_format=utils.suggest_memory_format(self), **options)
    else:
