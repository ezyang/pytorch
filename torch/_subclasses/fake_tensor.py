...
class FakeTensorConverter(object):
    ...
    def from_real_tensor(
        self, fake_mode, t, make_constant=False, shape_env=None, ignore_subclass=False, *, sname=None
    ):
...
class FakeTensorMode(TorchDispatchMode):
    ...
    def from_tensor(self, tensor, static_shapes=False, ignore_subclass=False, sname: Optional[str] = None):
        if static_shapes:
            return self.fake_tensor_converter(
                self, tensor, ignore_subclass=ignore_subclass, sname=sname
            )
        return self.fake_tensor_converter(
            self, tensor, shape_env=self.shape_env, ignore_subclass=ignore_subclass, sname=sname
        )
