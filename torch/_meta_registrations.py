...
def zeros_like(self, dtype=None, layout=None, device=None, pin_memory=None, memory_format=None):
    if layout == torch.sparse_coo:
        check(memory_format is None, lambda: "memory format option is only supported by strided tensors")
        ...
        return res
    return aten.empty_like.default(self, dtype, layout, device, pin_memory, memory_format)
